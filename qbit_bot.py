...
class QbitTasker:
    ...
    def _get_keyring_for_search_parser(self):
        try:
    ...
    def _start_search(self):
        try:
            search_parser_keys, search_term = self._get_keyring_for_search_parser(), self._get_search_term_from_search_detail_parser_at_active_header()
